...
function salvarDadosHospital(event) {
...
function salvarAparenciaSistema(event) {
    ...
    reader.onload = function (e) {
        ...
        const dados = {
            ...
            rodape: document.getElementById("rodape").value.trim()
        };
...
document.getElementById("formAparenciaSistema").addEventListener("submit", function (e) {
    e.preventDefault();
    if (!validarAparenciaSistema()) return;
